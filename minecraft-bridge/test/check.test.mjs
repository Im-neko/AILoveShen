...
test('conditions are judged without touching the goal', () => {
...
test('only predicates judged from the world can be conditions', () => {
...
test('a condition that cannot be judged yet is not met, and the others are still judged', () => {
